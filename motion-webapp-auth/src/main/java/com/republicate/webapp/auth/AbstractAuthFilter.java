...
public abstract class AbstractAuthFilter<USER> implements Filter
{
    ...
    protected String findConfigParameter(String key)
    {
        ...
        // then velococity properties
        if (value == null)
        {
            // TODO - this won't work well if VelocityEngine is not shared
            value = (String)ServletUtils.getVelocityView(getConfig()).getVelocityEngine().getProperty(key);
        }
        return value;
    }
