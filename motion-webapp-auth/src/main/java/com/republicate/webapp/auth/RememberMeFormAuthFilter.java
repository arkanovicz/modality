 ...
 *     all previous parameters are ignored, next ones are taken into account. The default handler is <code>com.republicate.webapp.auth.RememberMeCookieHandlerImpl</code></li>
